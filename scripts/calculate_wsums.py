...
def get_args():
    ...
    parser.add_argument('--rot_chunk',  type=int, default = 0, help='calculate for a subset of rotations')
    parser.add_argument('--rot_chunks', type=int, default = 1, help='number of blocks to split rotations over')
...
if __name__ == "__main__":
    ...
    if args.rot_chunk is not None:
        if not args.rot_chunks :
            raise ValueError(f'must specify total number of rot_chunks')
